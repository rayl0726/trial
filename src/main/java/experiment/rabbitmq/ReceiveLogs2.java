...
public class ReceiveLogs2 {
    ...
    private static final String QUEUE_NAME = "receive2";
    ...
    public static void main(String[] argv) throws Exception {
        ...
        channel.basicQos(7000);
        System.out.println(" [Receive2] Waiting for messages. To exit press CTRL+C");
        ...
        Consumer consumer = new Consumer() {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                try{
                    ...
                    logger.info(" [Receive2] Received '" + message + "'");
                } catch (Exception e) {
                    logger.error("[Receive2] Handle message error : {}", e.getMessage());
                } finally {
                    logger.info("[Receive2] Done");
